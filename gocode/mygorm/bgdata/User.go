...
func (s *UserInfo) MyInsertOne() {
	u := &UserInfo{}
	u.Name = myrand.GetCnName()
	u.Gender = myrand.GetGender()
	u.RegInfo.RegIp = myrand.GetIp()
	country := myrand.GetCountry()
	u.CountryCn = country.Cn
	u.CountryEn = country.En
	u.CountryPhoneCode = country.PhoneCode
